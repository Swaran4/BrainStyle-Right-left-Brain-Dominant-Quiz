const questions = [
  {
    ...
    answers: [
      ...
      {
        text: "Understand both the logic and creative possibilities",
        type: "whole",
      },
    ],
  },
...

  {
    ...
    answers: [
      ...
      {
        text: "Provide facts with flair—make it engaging but accurate ",
        type: "whole",
      },
    ],
  },

  {
    ...
    answers: [
      ...
      {
        text: "Controlled chaos—looks messy but I know where things are ",
        type: "right",
      },
...

  {
    ...
    answers: [
      {
        text: "Organizing events, managing clubs, or leading projects",
        type: "left",
      },
